...
CREATE TABLE `order_list` (
  ...
  KEY `fk_member_id_member_info` (`member_id`),
  CONSTRAINT `fk_member_id_member_info` FOREIGN KEY (`member_id`) REFERENCES `member_info` (`member_id`)
...
INSERT INTO `order_list` VALUES (28,1,NULL,1),(29,1,NULL,1);
